...
design_libs=(xbip_utils_v3_0_14 c_reg_fd_v12_0_10 xbip_dsp48_wrapper_v3_0_6 xbip_pipe_v3_0_10 c_addsub_v12_0_19 xil_defaultlib)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.c_mio_sommatore -o c_mio_sommatore_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./c_mio_sommatore_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/diamant/Scrivania/Matrix_Multiplication_in_FPGA/Matrix_Multiplication_in_FPGA.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key c_mio_sommatore_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc c_mio_sommatore_simv.daidir vcs_lib c.obj)
