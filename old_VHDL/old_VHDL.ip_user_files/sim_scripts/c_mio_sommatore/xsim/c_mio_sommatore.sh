...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xbip_utils_v3_0_14 -L c_reg_fd_v12_0_10 -L xbip_dsp48_wrapper_v3_0_6 -L xbip_pipe_v3_0_10 -L c_addsub_v12_0_19 -L secureip -L xpm --snapshot c_mio_sommatore xil_defaultlib.c_mio_sommatore -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim c_mio_sommatore -key {Behavioral:sim_1:Functional:c_mio_sommatore} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb c_mio_sommatore.wdb xsim.dir libdpi.so)
